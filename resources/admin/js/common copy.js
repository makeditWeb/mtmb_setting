...
const inquiry_chart_background_colors = [
  "rgba(255, 99, 132, 0.3)",
  "rgba(255, 159, 64, 0.3)",
  "rgba(255, 205, 86, 0.3)",
  "rgba(75, 192, 192, 0.3)",
...
const request_chart_background_colors = [
  "rgba(255, 99, 132, 0.7)",
  "rgba(255, 159, 64, 0.7)",
  "rgba(255, 205, 86, 0.7)",
  "rgba(75, 192, 192, 0.7)",
...
$(function () {
  ...
  $(document).on("click", ".pop_view", function () {
    ...
    window.open(thisdata.path + thisdata.idx, "pop_window", popupOptions);
  });
});
...
function set_date_range(date_range) {
  ...
  switch (date_range) {
    ...
    case 2:
      ...
      break;
    case 3:
      var lastMonth = new Date(curr_date.getFullYear(), curr_date.getMonth() - 1, 1);
