			...
			<table class="table table-bordered list_table mt-2" width="100%" cellspacing="0">
				...
				<thead>
					<tr>
						...
						<th class="selectSort <?php if ($page_info['sort_key'] == 'ex_sdate') echo ($page_info['sort_direction'] == 'desc') ? 'desc' : 'asc'; ?>" data-sort_key="ex_sdate">시작일</th>
						<th class="selectSort <?php if ($page_info['sort_key'] == 'ex_edate') echo ($page_info['sort_direction'] == 'desc') ? 'desc' : 'asc'; ?>" data-sort_key="ex_edate">종료일</th>
						<th class="selectSort <?php if ($page_info['sort_key'] == 'is_active') echo ($page_info['sort_direction'] == 'desc') ? 'desc' : 'asc'; ?>" data-sort_key="is_active">활성화</th>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="text-center"><?= replaceDatetime($list->ex_sdate) ?></td>
							<td class="text-center"><?= replaceDatetime($list->ex_edate) ?></td>
